...
function renderEventRow(data) {
  ...
  let foodTotalCost = order.food
    .map(index => index.pricePerOrder * index.quantity)
    .reduce((a, b) => {
      return a + b;
    });
  let bevTotalCost = order.beverages
    .map(index => index.pricePerOrder * index.quantity)
    .reduce((a, b) => {
      return a + b;
    });
  ...
  $eventTable.append(
    `
            <tr class="table_row">
                <td class="table_td"><span class="row_list_category"></span> ${
                  contact.lastName
                ...
                <td class="event_report_path table_td"><a href="#" id="${id}" class="event_id" aria-label="Click to view ${
      contact.lastName
    }'s invoice">View Invoice</a></td>
            </tr>
        `
  );
}
        ...
        <div class="event_report_display">
            ...
            <div class="report_invoice">
                <div class="invoice_order">
                    ...
                    <div class="">
                        <ul class="order_grouping">
                            <li class="item_name order_li"><span class="item_name">Item:</span> ${
                              item.type
                            }</li>
                            <li class="order_li"><span>Cost per item:</span> ${
                              item.pricePerOrder
                            }</li>
                            <li class="order_li"><span>Quantity:</span> ${
                              item.quantity
                            }</li>
                            <li class="order_li"><span>Order Price:</span> $${JSON.parse(
                              item.pricePerOrder
                            ) * JSON.parse(item.quantity)}</li>
                        </ul>
                    </div>
                    `;
                      })
                    ...
                    <div class="">
                        <ul class="order_grouping">
                            <li class="item_name order_li"><span>Item:</span> ${
                              item.type
                            }</li>
                            <li class="order_li"><span>Cost per item:</span> ${
                              item.pricePerOrder
                ...
                <ul class="order_totals">
                    ...
                    <li class="total_li total_border">Rental Price: <span class="total">$${
                      order.rentalPrice
                    }</span></li>
    ...
    `
        ...
        <fieldset class="update_field">
            ...
            <label for="update_firstName" class=""><span>First Name</span>
                <input type="text" id="update_firstName" class="" value="${
                  contact.firstName
                }">
            </label>
            <label for="update_lastName" class=""><span>Last Name</span>
                <input type="text" id="update_lastName" class="" value="${
                  contact.lastName
                }">
            </label>
            <label for="update_email" class=""><span>Email</span>
                <input type="text" id="update_email" class="" value="${
                  contact.email
                }">
            </label>
            <label for="update_phone" class=""><span>Phone</span>
                <input type="text" id="update_phone" class="" value="${
                  contact.phone
                }">
            </label>
        </fieldset>
                  ...
                  .map(item => {
                    ...
                    <div class="food_input_group">
                        <label for="food_item" class="update_border"><span>Item</span>
                            <input type="text" id="${
                              item._id
                            }" class="food_type" value="${
                      item.type
                    }" name="type">
                        </label>
                        <label for="food_cost"><span>Item Cost</span>
                            <input type="number" class="food_cost" value="${
                              item.pricePerOrder
                            }" name="pricePerOrder">
                        </label>
                        <label for="food_quantity"><span>Quantity</span>
                            <input type="number" class="food_quantity" value="${
                              item.quantity
                            }" name="quantity">
                        </label>
                    </div>
                ...
                <div class="bev_order_input2" aria-live="assertive">
                    ...
                    <div class="bev_input_group">
                        <label for="update_bev_item" class="update_border"><span>Item</span>
                            <input type="text" id="${
                              item._id
                            }" class="bev_type" value="${
                          item.type
                        }" name="type">
                        </label>
                        <label for="=bev_cost"><span>Item Cost</span>
                            <input type="number" class="bev_cost" value="${
                              item.pricePerOrder
                            }" name="pricePerOrder">
                        </label>
                        <label for="bev_quantity"><span>Quantity</span>
                            <input type="number" class="bev_quantity" value="${
                              item.quantity
                            }" name="quantity">
                        </label>
                    </div>
        ...
        <fieldset class="update_field">
            ...
            <label for="update_rental_price"><span>Rental Price</span>
                <input type="number" id="update_rental_price" value="${
                  order.rentalPrice
                }" required>
            </label>
        </fieldset>
